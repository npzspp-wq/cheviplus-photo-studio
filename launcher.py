...
# Visible version/build belongs to the newest marketplace compatibility module.
renewal.APP_VERSION = marketplace_1c.APP_VERSION
renewal.APP_BUILD = marketplace_1c.APP_BUILD
renewal.app.APP_VERSION = marketplace_1c.APP_VERSION
renewal.app.APP_BUILD = marketplace_1c.APP_BUILD


if __name__ == "__main__":
    prepare_upgrade_environment(marketplace_1c.APP_VERSION)
