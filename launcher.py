...
# Visible version/build belongs to the newest marketplace module.
renewal.APP_VERSION = marketplace.APP_VERSION
renewal.APP_BUILD = marketplace.APP_BUILD
renewal.app.APP_VERSION = marketplace.APP_VERSION
renewal.app.APP_BUILD = marketplace.APP_BUILD


if __name__ == "__main__":
    prepare_upgrade_environment(marketplace.APP_VERSION)
